...
```{r isg-feature, eval=FALSE, fig.alt="FeaturePlot showing ISG15 and IFIT1 expression split by condition. Both genes show strong expression across multiple cell types in the stimulated condition but are nearly absent in the control condition."}
FeaturePlot(ifnb,
...
```{r isg-violin, eval=FALSE, fig.alt="Violin plots showing ISG15 expression in CD14 monocytes, split by control and stimulated condition. The stimulated condition shows dramatically higher ISG15 expression."}
VlnPlot(ifnb,
