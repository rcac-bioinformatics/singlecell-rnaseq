...
```{r create-pseudo-reps, eval=FALSE}
...
```{r volcano, eval=FALSE, fig.alt="Volcano plot showing differential expression results for stimulated versus control CD14 monocytes. Significant upregulated genes appear in the upper right (including CCL8, CXCL10, IFIT1), significant downregulated genes in the upper left, and non-significant genes cluster near the bottom center."}
...
```{r de-viz, eval=FALSE, fig.alt="FeaturePlot showing IFIT1 expression split by control and stimulated conditions. IFIT1 is nearly absent in control cells but strongly expressed across multiple cell types in stimulated cells, especially monocytes."}
FeaturePlot(ifnb,
            features = "IFIT1",
            split.by = "stim",
...
```{r de-violin, eval=FALSE, fig.alt="Violin plots showing IFIT1, CXCL10, and MX1 expression across cell types, split by control and stimulated conditions. All three genes are dramatically upregulated in the stimulated condition across multiple cell types."}
VlnPlot(ifnb,
...
```{r de-dotplot, eval=FALSE, fig.alt="Dot plot showing expression of the top 10 DE genes across all cell types, split by condition. Interferon-stimulated genes and chemokines are consistently upregulated across all cell types in the stimulated condition."}
...
```{r go-dotplot, eval=FALSE, fig.alt="Dot plot showing the top 15 enriched GO biological process terms for upregulated genes in stimulated monocytes. The top terms are response to virus, defense response to virus, viral process, and viral life cycle, with response to type I interferon and interferon-mediated signaling pathway appearing lower in the list."}
