...
```{r annotated-umap, eval=FALSE, fig.alt="UMAP plot with cells colored and labeled by cell type name. Nine groups are visible: CD4 T (large, upper-left), CD14 Mono (lower-left), NK (upper-center), DC (upper-right), B (right), CD8 T (right), FCGR3A+ Mono (lower-right), pDC (small, lower-center), and Platelet (small, bottom)."}
