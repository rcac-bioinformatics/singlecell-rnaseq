...
You will also need the `ifnb_annotated.rds` object saved at the end of the
previous episode.
...
![Split UMAP showing CTRL and STIM panels with cells colored and labeled by cell type.](fig/ep8_umap_split.png){alt="UMAP split by CTRL and STIM conditions with nine cell types colored and labeled, showing identical spatial arrangement in both panels confirming successful integration."}
...
![Volcano plot for CD14 monocytes STIM vs CTRL.](fig/ep8_volcano.png){alt="Volcano plot showing upregulated genes in red in the upper right, downregulated genes in blue in the upper left, and non-significant genes in grey near the bottom, with dashed cutoff lines for significance and fold change."}
...
![FeaturePlot of IFIT1 split by CTRL and STIM.](fig/ep8_featureplot_ifit1.png){alt="Feature plot of IFIT1 expression split by condition showing near-absent expression in control cells and strong expression across all cell types in stimulated cells, especially monocytes."}
...
![Violin plots for IFIT1, CXCL10, and MX1 across cell types, split by condition.](fig/ep8_violin_de.png){alt="Three violin plot panels showing IFIT1, CXCL10, and MX1 dramatically upregulated in stimulated cells across all cell types, with control violins near zero and stimulated violins broad and tall."}
...
![Dot plot of top 10 DE genes across cell types split by condition.](fig/ep8_dotplot_de.png){alt="Dot plot showing top 10 DE genes across all cell types split by CTRL and STIM, with dot size indicating percent expressed and color indicating average expression, showing consistently larger and redder dots in stimulated cells."}
...
![GO Biological Process dot plot for STIM vs CTRL CD14 monocytes.](fig/ep8_go_dotplot.png){alt="GO enrichment dot plot showing 15 biological process terms with response to virus, defense response to virus, and viral process as the top three by gene ratio, with dot color from red to blue indicating adjusted p-value."}
...
![Scatter plot comparing p-values from Wilcoxon and pseudobulk DE tests.](fig/ep8_pval_comparison.png){alt="Scatter plot of negative log10 p-values from Wilcoxon versus pseudobulk for shared genes, with a red dashed diagonal showing equal significance and points broadly scattered indicating different significance rankings between methods."}
...
![GO BP dot plot for the top 200 upregulated genes in STIM CD14 monocytes.](fig/ep8_go_top200.png){alt="GO enrichment dot plot for top 200 upregulated genes showing 10 biological process terms with response to virus and defense response to virus having the largest gene ratios and deepest red color indicating lowest adjusted p-values."}
